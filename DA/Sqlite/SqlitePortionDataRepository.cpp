...
std::vector<ResultDataType> SqlitePortionDataRepository::GetEuclideanMetricData() {
    ...
    std::string query = "with sleepdataavg as\n"
                        ...
                        "from sleepdataavg \n"
                        "where cpufreq != 2701000 and cpufreq != 2700000 and cpufreq != 2600000)\n"
                        ",\n"
                        "dataavg as\n"
                        ...
                        ",\n"
                        "tab as\n"
                        "(select ct, mrpi, power, system_cost, system_cost * ct as cost, 0.98 * (power - system_cost * ct) * (power - system_cost * ct) + 2.9 * ct * ct  as edp, cpuportion, dataavg.cpufreq\n"
